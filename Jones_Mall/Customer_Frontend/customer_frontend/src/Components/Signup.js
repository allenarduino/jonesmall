...
//Creating the Signup class  component
...
//Function for input handling
    ...
    signup=(e)=>{
       ...
       //If all fields are cleared, send input data to server
        if(validateForm(this.state.errors)){
          ...
          /*Javascript fetch() inbuilt function for making http request to server
          or back end API endpoint
          */
        ...
        return(
            ...
            <div className="bg">
                  ...
                  <div className="form-container ">
                      ...
                      <h3 style={{color:"grey",fontSize:20}}>Signup to order</h3>
                          ...
                          />
                          {/**If fullname>0, show error message */}
                       ...
                       <input type="password" onChange={this.handleinput}
                          ...
                          <Link to="/login">
                            <a  style={{fontSize:15,color:"rgb(73, 8, 73)"}}>
                              Login
                              </a> 
                              </Link>
                              </h3>
